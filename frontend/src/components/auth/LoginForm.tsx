/**
 * LoginForm Component - OAuth Authentication
 *
 * Features:
 * - Google/GitHub/Apple OAuth buttons
 * - Provider-specific hover glows
 * - Sound wave ripple loading effect
 ...
 *
 * Creates a pulsing sound wave ripple effect with 4 concentric circles
 * that expand outward and fade out, mimicking audio visualizer/sonar ping
 *
