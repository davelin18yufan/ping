        ...
        <div className="p-4">
            ...
            <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4">
                ...
                <p className="text-sm mt-2">
                    This demo uses <code className="bg-blue-200 px-1 rounded">preloadQuery</code> in
                    the loader and <code className="bg-blue-200 px-1 rounded">useReadQuery</code> in
                    the component for optimal streaming SSR performance.
                </p>
            </div>
